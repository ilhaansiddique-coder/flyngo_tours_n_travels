...
var JwtAuthGuard = function () {
    ...
    var JwtAuthGuard = _classThis = /** @class */ (function () {
        function JwtAuthGuard_1(jwtService, reflector, configService, prisma) {
        ...
        JwtAuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var isPublic, request, token, payload, user, permissions, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            isPublic = this.reflector.getAllAndOverride(public_decorator_1.PUBLIC_KEY, [
                                context.getHandler(),
                                context.getClass(),
                            ]);
                            if (isPublic)
                        ...
                        case 3:
                            ...
                            permissions = user.role.permissions.map(function (rp) { return rp.permission.code; });
                            request['user'] = {
                                id: user.id,
                                email: user.email,
                                roleId: user.roleId,
