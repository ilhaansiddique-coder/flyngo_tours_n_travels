...
var PermissionsGuard = function () {
    ...
    var PermissionsGuard = _classThis = /** @class */ (function () {
        ...
        PermissionsGuard_1.prototype.canActivate = function (context) {
            var isPublic = this.reflector.getAllAndOverride(public_decorator_1.PUBLIC_KEY, [
                context.getHandler(),
                context.getClass(),
            ]);
            if (isPublic)
            ...
            if (!(user === null || user === void 0 ? void 0 : user.permissions))
                return false;
            return requiredPermissions.every(function (perm) { return user.permissions.includes(perm); });
        };
