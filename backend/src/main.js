...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, logger, swaggerConfig, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    app = _a.sent();
                    configService = app.get(config_service_1.ConfigService);
                    ...
                    port = configService.get('BACKEND_PORT') || 4000;
                    return [4 /*yield*/, app.listen(port, configService.get('BACKEND_HOST') || '0.0.0.0')];
                case 2:
                    _a.sent();
                    logger.log("Server running on http://localhost:".concat(port));
