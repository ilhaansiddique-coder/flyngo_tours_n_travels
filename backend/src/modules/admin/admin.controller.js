...
var AdminController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Admin'), (0, swagger_1.ApiBearerAuth)(), (0, roles_decorator_1.Roles)('admin', 'super_admin'), (0, common_1.Controller)('admin')];
    ...
    var AdminController = _classThis = /** @class */ (function () {
        ...
        AdminController_1.prototype.getDashboard = function (tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminService.getDashboardStats(tenantId)];
                });
            });
        };
        AdminController_1.prototype.getAuditLogs = function (tenantId, pagination) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminService.getAuditLogs(tenantId, pagination.page, pagination.limit)];
                });
            });
        };
    ...
    (function () {
        ...
        _getDashboard_decorators = [(0, common_1.Get)('dashboard'), (0, swagger_1.ApiOperation)({ summary: 'Get admin dashboard stats' })];
