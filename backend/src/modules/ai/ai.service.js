...
var AiService = function () {
    ...
    var AiService = _classThis = /** @class */ (function () {
        ...
        AiService_1.prototype.getTravelRecommendations = function (preferences) {
        ...
        AiService_1.prototype.getVisaAssistance = function (destination, nationality) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("Checking visa requirements for ".concat(nationality, " \u2192 ").concat(destination));
                    return [2 /*return*/, {
                            requirements: [],
        ...
        AiService_1.prototype.planItinerary = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.logger.log("Planning itinerary for ".concat(params.destination));
                    return [2 /*return*/, {
                            itinerary: [],
