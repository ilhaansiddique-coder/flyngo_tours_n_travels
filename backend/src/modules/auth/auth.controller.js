...
var token_response_dto_1 = require("./dto/token-response.dto");
...
var AuthController = function () {
        ...
        AuthController_1.prototype.login = function (dto, req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.authService.login(dto, tenantId)];
                });
            });
        };
        AuthController_1.prototype.register = function (dto, req) {
            return __awaiter(this, void 0, void 0, function () {
                var tenantId;
                return __generator(this, function (_a) {
                    tenantId = req.tenantId;
                    return [2 /*return*/, this.authService.register(dto, tenantId)];
                });
            });
        };
        AuthController_1.prototype.refresh = function (refreshToken, req) {
            return __awaiter(this, void 0, void 0, function () {
                var tenantId;
                return __generator(this, function (_a) {
                    tenantId = req.tenantId;
                    return [2 /*return*/, this.authService.refreshToken(refreshToken, tenantId)];
                });
            });
        };
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, public_decorator_1.Public)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Login with email and password' }), (0, swagger_1.ApiBody)({ type: login_dto_1.LoginDto }), (0, swagger_1.ApiResponse)({ status: 200, type: token_response_dto_1.TokenResponseDto })];
        _register_decorators = [(0, common_1.Post)('register'), (0, public_decorator_1.Public)(), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({ summary: 'Register new customer account' }), (0, swagger_1.ApiBody)({ type: register_dto_1.RegisterDto }), (0, swagger_1.ApiResponse)({ status: 201, type: token_response_dto_1.TokenResponseDto })];
        _refresh_decorators = [(0, common_1.Post)('refresh'), (0, public_decorator_1.Public)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Refresh access token' })];
