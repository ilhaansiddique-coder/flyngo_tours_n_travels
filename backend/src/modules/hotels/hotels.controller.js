...
var HotelsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Hotels'), (0, common_1.Controller)('hotels')];
    ...
    var HotelsController = _classThis = /** @class */ (function () {
        ...
        HotelsController_1.prototype.findAll = function (tenantId, pagination) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.hotelsService.findAll(tenantId, pagination.page, pagination.limit)];
                });
            });
        };
        HotelsController_1.prototype.findById = function (id, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.hotelsService.findById(id, tenantId)];
                });
            });
        };
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'List all hotels' })];
        _findById_decorators = [(0, common_1.Get)(':id'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Get hotel by ID' })];
