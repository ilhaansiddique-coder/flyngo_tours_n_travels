...
<body>
  ...
  /**
   * Resolve a stored media URL (which may be a relative path served under
   * /api/v1/uploads) into an absolute URL usable inside invoices.
   */
  private absoluteUrl(url?: string | null): string {
