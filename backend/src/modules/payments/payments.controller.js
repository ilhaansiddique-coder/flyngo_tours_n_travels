...
var PaymentsController = function () {
    ...
    var PaymentsController = _classThis = /** @class */ (function () {
        ...
        PaymentsController_1.prototype.createIntent = function (tenantId, userId, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.createPaymentIntent(tenantId, userId, body.bookingId, body.method, body.amount)];
                });
            });
        };
        PaymentsController_1.prototype.getStatus = function (id, tenantId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.getPaymentStatus(id, tenantId, userId)];
                });
            });
        };
        PaymentsController_1.prototype.stripeWebhook = function (signature, req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.handleStripeWebhook(signature, req.rawBody)];
                });
            });
        };
        PaymentsController_1.prototype.bkashWebhook = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.paymentsService.handleBKashWebhook(body)];
                });
            });
        };
    ...
    (function () {
        ...
        _createIntent_decorators = [(0, common_1.Post)('intent'), (0, swagger_1.ApiOperation)({ summary: 'Create payment intent' })];
        _getStatus_decorators = [(0, common_1.Get)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Get payment status' })];
        _stripeWebhook_decorators = [(0, common_1.Post)('webhook/stripe'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Stripe webhook' })];
        _bkashWebhook_decorators = [(0, common_1.Post)('webhook/bkash'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'bKash webhook' })];
        ...
        __esDecorate(_classThis, null, _bkashWebhook_decorators, { kind: "method", name: "bkashWebhook", static: false, private: false, access: { has: function (obj) { return "bkashWebhook" in obj; }, get: function (obj) { return obj.bkashWebhook; } }, metadata: _metadata }, null, _instanceExtraInitializers);
