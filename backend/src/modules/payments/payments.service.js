...
var PaymentsService = function () {
    ...
    var PaymentsService = _classThis = /** @class */ (function () {
        ...
        PaymentsService_1.prototype.createPaymentIntent = function (tenantId, userId, bookingId, method, amount) {
            return __awaiter(this, void 0, void 0, function () {
                var booking, payment;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.booking.findFirst({
                                where: { id: bookingId, tenantId: tenantId, userId: userId },
                            })];
                        case 1:
                            booking = _a.sent();
                            if (!booking) {
                            ...
                            return [4 /*yield*/, this.prisma.payment.create({
                                    data: {
                                        ...
                                        method: method,
                                        status: 'pending',
                                        transactionId: "PAY-".concat(Date.now()),
                                    },
                                })];
                        case 2:
                            payment = _a.sent();
        ...
        PaymentsService_1.prototype.getPaymentStatus = function (id, tenantId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.payment.findFirst({
                            where: { id: id, tenantId: tenantId, userId: userId },
                        })];
                });
            });
        };
        PaymentsService_1.prototype.handleStripeWebhook = function (signature, payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        PaymentsService_1.prototype.handleBKashWebhook = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
