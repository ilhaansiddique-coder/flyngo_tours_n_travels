...
var UsersController = function () {
        ...
        UsersController_1.prototype.getProfile = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.findById(user.id, user.tenantId)];
                });
            });
        };
        UsersController_1.prototype.updateProfile = function (user, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.updateProfile(user.id, user.tenantId, body)];
                });
            });
        };
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: 'Get current user profile' })];
