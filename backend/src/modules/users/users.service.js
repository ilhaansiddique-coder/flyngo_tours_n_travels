...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findById = function (id, tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var user, passwordHash, userWithoutPassword;
        ...
        UsersService_1.prototype.updateProfile = function (id, tenantId, data) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.findById(id, tenantId)];
                    }
                });
            });
        };
        UsersService_1.prototype.list = function (tenantId, page, limit) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, users, total;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    items: users.map(function (_a) {
                                        var passwordHash = _a.passwordHash, rest = __rest(_a, ["passwordHash"]);
                                        return rest;
                                    }),
                                    total: total,
                                    page: page,
