    ...
    <div className="space-y-6">
      ...
      <Card hover={false} padding="none">
        ...
        <div className="flex items-center justify-between p-4 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="flex gap-1">
            <button
              className="px-3 py-1 rounded-lg text-sm bg-gray-100 dark:bg-surface-container hover:bg-gray-200 dark:hover:bg-surface-container-high disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={page <= 1}
      ...
      {selectedLog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white dark:bg-surface-container-low rounded-2xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              {selectedLog.userAgent && (
                <div>
                  ...
                  <p className="text-xs font-mono break-all bg-gray-50 dark:bg-surface-container p-2 rounded">{selectedLog.userAgent}</p>
                </div>
              )}
              {selectedLog.oldValue && (
                <div>
                  <p className="text-gray-500 mb-1">Previous Value:</p>
                  <pre className="text-xs font-mono bg-gray-50 dark:bg-surface-container p-2 rounded overflow-x-auto">{JSON.stringify(selectedLog.oldValue, null, 2)}</pre>
                </div>
              )}
              {selectedLog.newValue && (
                <div>
                  <p className="text-gray-500 mb-1">New Value:</p>
                  <pre className="text-xs font-mono bg-gray-50 dark:bg-surface-container p-2 rounded overflow-x-auto">{JSON.stringify(selectedLog.newValue, null, 2)}</pre>
                </div>
              )}
            </div>
          </div>
