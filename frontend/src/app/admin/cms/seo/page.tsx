                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 mt-1"
                      />
                    </div>
                  </div>
                </div>
