...
export default function AdminLoyaltyPage() {
  ...
  const [tierForm, setTierForm] = useState({ name: '', slug: '', color: '#C0C0C0', starCount: 1, minPoints: 0, redemptionMultiplier: 1.0, sortOrder: 0, isActive: true });
  ...
  const openCreateTier = () => {
    setTierForm({ name: '', slug: '', color: '#C0C0C0', starCount: 1, minPoints: 0, redemptionMultiplier: 1.0, sortOrder: tiers.length + 1, isActive: true });
