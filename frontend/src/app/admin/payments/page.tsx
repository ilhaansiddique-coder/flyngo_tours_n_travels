        ...
        <Card hover={false}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {Object.entries(stats.byMethod).map(([method, count]) => (
              <div key={method} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                  ...
                  payments.map((p) => (
                    <tr key={p.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/30">
                      ...
                      <td className="p-4 font-mono text-xs">
                        {p.booking?.bookingCode ? (
                          <a className="text-brand-600 hover:underline" href={`/admin/bookings`}>{p.booking.bookingCode}</a>
                        ) : '—'}
                      </td>
                      <td className="p-4">
                      ...
                      <td className="p-4">
                        <select
                          ...
                          className="text-xs border border-gray-300 dark:border-gray-700 rounded-lg px-2 py-1 bg-white dark:bg-gray-800"
                        >
                          <option value="pending">Pending</option>
                          <option value="processing">Processing</option>
                          <option value="completed">Completed</option>
