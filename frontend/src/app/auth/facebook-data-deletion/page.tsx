      ...
      <Section>
        <Container size="narrow">
          <div className="prose dark:prose-invert max-w-none">
            ...
            <h2 className="font-display text-2xl font-bold text-on-surface mt-12">
              How deletion works
            </h2>
                ...
                <Card key={title} hover={false} className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-on-surface-variant leading-relaxed">{body}</p>
                    </div>
                  </div>
                </Card>
              ))}
            ...
            <ul className="text-on-surface-variant space-y-2 mt-3">
