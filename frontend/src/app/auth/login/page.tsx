      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass p-8 rounded-2xl border-outline-variant">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-on-surface-variant cursor-pointer">
                <input type="checkbox" className="rounded border-outline-variant bg-surface-container text-blue-600 focus:ring-blue-500" />
                Remember me
              </label>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-background text-on-surface-variant">Or continue with</span></div>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-on-surface-variant">
            ...
            <Link href="/auth/register" className="text-blue-400 font-semibold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
