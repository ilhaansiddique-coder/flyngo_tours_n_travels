    ...
    <div className="relative min-h-screen bg-background flex items-center justify-center px-4 py-12 overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 50% at 30% 30%, color-mix(in oklab, var(--color-primary) 18%, transparent), transparent 70%), radial-gradient(ellipse 50% 45% at 75% 70%, color-mix(in oklab, var(--color-tertiary) 14%, transparent), transparent 70%)',
          }}
        />
      </div>
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-on-surface-variant">Sign in with your email or phone</p>
        </div>
        ...
        <div className="glass-deep p-8 rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-on-surface-variant cursor-pointer">
                ...
                <input type="checkbox" className="rounded accent-accent focus:ring-accent" />
                Remember me
              </label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-outline-variant bg-surface-container/60 text-sm font-medium text-on-surface hover:bg-surface-container-high hover:border-outline transition-colors">
