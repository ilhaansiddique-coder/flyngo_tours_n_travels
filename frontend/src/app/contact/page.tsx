...
export default function ContactPage() {
  ...
  // prerendered, and useSearchParams would force a Suspense boundary — the
  // exact construct that has silently broken hydration on /booking twice.
  useEffect(() => {
    const subject = new URLSearchParams(window.location.search).get('subject');
    if (subject) setMessage((current) => current || subject);
  }, []);
