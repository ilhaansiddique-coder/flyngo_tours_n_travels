          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 p-7 sm:p-8">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  {exp.cta}
                  <span className="w-7 h-7 rounded-full border border-soft group-hover/btn:border-accent group-hover/btn:bg-accent group-hover/btn:text-[var(--color-on-primary)] flex items-center justify-center transition-all">
