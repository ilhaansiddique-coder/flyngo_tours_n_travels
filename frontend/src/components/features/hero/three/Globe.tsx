...
export default function Globe({
  ...
  return (
    <Canvas
      ...
      onCreated={({ gl }) => {
        // Recover gracefully from a lost WebGL context (GPU reset, tab
        // backgrounding, driver hiccup) instead of leaving a dead canvas.
        // preventDefault on `webglcontextlost` tells the browser we intend to
        // restore, so it fires `webglcontextrestored` rather than giving up.
