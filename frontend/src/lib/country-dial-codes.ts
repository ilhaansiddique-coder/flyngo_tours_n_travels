...
export const COUNTRY_DIALS: CountryDial[] = [
  ...
  { code: 'MF', name: 'Saint Martin (French)', dial: '+590', flag: '🇲🇫' },
  ...
  { code: 'SX', name: 'Sint Maarten (Dutch)', dial: '+1721', flag: '🇸🇽' },
...
export function findDialByCode(code: string): CountryDial | undefined {
